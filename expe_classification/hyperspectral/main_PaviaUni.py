...
from data import read_pavia_university
...
if __name__ == "__main__":
    ...
    data, labels, labels_names = read_pavia_university(
        path + "/hyperspectral/datasets/"
    )
    ...
    results_df.to_pickle(
        path + "/hyperspectral/results/results_Pavias_Uni_diagonal.pkl"
    )
