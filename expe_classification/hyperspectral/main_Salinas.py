...
if __name__ == "__main__":
    ...
    data, labels, labels_names = read_salinas(path + "/hyperspectral/datasets/")
    ...
    results_df.to_pickle(path + "/hyperspectral/results/results_Salinas_diagonal.pkl")
